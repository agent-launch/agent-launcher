...
export const messages: Record<'zh' | 'en', Record<string, string>> = {
  zh: {
    ...
    'settings.cliStatus.title': 'Agent CLI 版本与安装',
    'settings.cliStatus.desc': '这里只检测各 CLI 的当前版本和最新版本。Agent Launcher 不会重装或更新 CLI；安装和升级请按各项目官方文档操作。',
  ...
  en: {
    ...
    'settings.cliStatus.title': 'Agent CLI versions and installation',
    'settings.cliStatus.desc':
      'This page only compares installed and latest CLI versions. Agent Launcher does not reinstall or update CLIs; follow each project\'s official documentation to install or upgrade.',
