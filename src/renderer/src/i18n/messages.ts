...
export const messages: Record<'zh' | 'en', Record<string, string>> = {
  zh: {
    ...
    'shell.tabExited': '已退出',
    'shell.sessionNotSaved': '这段对话未被保存，关闭后无法恢复',
    ...
    'config.connection.costNotice': '将发送一次实际模型请求，可能消耗少量 Token',
  ...
  en: {
    ...
    'shell.allDirectories': 'All directories',
    ...
    'shell.sessionNotSaved': "This conversation isn't saved and can't be recovered after closing",
