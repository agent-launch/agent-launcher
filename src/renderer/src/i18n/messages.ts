...
export const messages: Record<'zh' | 'en', Record<string, string>> = {
  zh: {
    ...
    'shell.unassociatedDirectory': '未关联目录',
    'shell.openFolder': '打开文件夹…',
    'shell.chooseDirectory': '选择目录',
    'shell.directoryMissing': '已失效',
    'shell.removeRecentProject': '从最近项目中移除',
    'shell.missingDirectoryHint': '所选目录已不存在，请重新选择目录',
    ...
    'config.model': 'Model',
    'config.modelPlaceholder': '填写模型名称',
    ...
    'config.modelDiscovery.empty': '没有匹配的模型',
    'config.modelDiscovery.use': '使用此模型',
    'config.modelDiscovery.invalid_config': '请填写 Base URL 和 API Key',
    'config.modelDiscovery.invalid_url': 'Base URL 格式不正确',
    'config.modelDiscovery.unauthorized': 'API Key 无效，无法获取模型列表',
    'config.modelDiscovery.forbidden': '当前 Key 无权查看模型列表',
    'config.modelDiscovery.payment_required': '账户余额不足或需要付费',
    'config.modelDiscovery.bad_request': '模型列表请求被服务拒绝',
    'config.modelDiscovery.unsupported_api': '服务未提供模型列表接口，请继续手动填写',
    'config.modelDiscovery.rate_limited': '请求过于频繁，请稍后重试',
    'config.modelDiscovery.server_error': '服务端暂时不可用',
    'config.modelDiscovery.http_error': '服务返回异常状态',
    'config.modelDiscovery.invalid_response': '服务没有返回可识别的模型列表，请继续手动填写',
    'config.modelDiscovery.timeout': '获取模型列表超时',
    'config.modelDiscovery.network_error': '网络、DNS 或 TLS 连接失败',
    ...
    'config.connection.test': '测试连接',
    'config.connection.testing': '测试中…',
    'config.connection.costNotice': '仅测试连接会发送实际模型请求，可能消耗少量 Token',
    'config.connection.ok': '连接成功',
    'config.connection.invalid_config': '请填写 Base URL、API Key 和 Model',
    'config.connection.invalid_url': 'Base URL 格式不正确',
    'config.connection.unauthorized': 'API Key 无效',
    'config.connection.forbidden': '当前 Key 没有访问权限',
    'config.connection.payment_required': '账户余额不足或需要付费',
    'config.connection.bad_request': '请求被拒绝，请检查模型名称和接口兼容性',
    'config.connection.unsupported_api': '生成接口或模型不存在',
    'config.connection.rate_limited': '请求过于频繁，请稍后重试',
    'config.connection.server_error': '服务端暂时不可用',
    'config.connection.http_error': '服务返回异常状态',
    'config.connection.invalid_response': '服务返回了无法识别的生成结果',
    'config.connection.backend_mismatch': '连接测试服务未更新，请重启应用后重试',
    'config.connection.timeout': '连接超时',
    'config.connection.network_error': '网络、DNS 或 TLS 连接失败',
  ...
  en: {
    ...
    'shell.unassociatedDirectory': 'Unassociated directory',
    'shell.openFolder': 'Open Folder…',
    'shell.chooseDirectory': 'Choose a directory',
    'shell.directoryMissing': 'Missing',
    'shell.removeRecentProject': 'Remove from recent projects',
    'shell.missingDirectoryHint': 'The selected directory no longer exists — pick another one',
    'shell.shellTabTitle': 'Shell',
    ...
    'config.model': 'Model',
    'config.modelPlaceholder': 'Enter model name',
    ...
    'config.modelDiscovery.search': 'Search model name or ID',
    'config.modelDiscovery.empty': 'No matching models',
    'config.modelDiscovery.use': 'Use this model',
    'config.modelDiscovery.invalid_config': 'Enter a Base URL and API Key',
    'config.modelDiscovery.invalid_url': 'The Base URL is invalid',
    'config.modelDiscovery.unauthorized': 'The API Key cannot access the model list',
    'config.modelDiscovery.forbidden': 'This key cannot view the model list',
    'config.modelDiscovery.payment_required': 'The account needs credit or payment',
    'config.modelDiscovery.bad_request': 'The service rejected the model-list request',
    'config.modelDiscovery.unsupported_api':
      'This service does not expose a model list. You can still enter a model manually',
    'config.modelDiscovery.rate_limited': 'Too many requests. Try again shortly',
    'config.modelDiscovery.server_error': 'The service is temporarily unavailable',
    'config.modelDiscovery.http_error': 'The service returned an unexpected status',
    'config.modelDiscovery.invalid_response':
      'The service did not return a recognized model list. You can still enter a model manually',
    'config.modelDiscovery.timeout': 'Fetching the model list timed out',
    'config.modelDiscovery.network_error': 'Network, DNS, or TLS connection failed',
    ...
    'config.connection.costNotice':
      'Only connection testing sends a real model request and may use a small number of tokens',
