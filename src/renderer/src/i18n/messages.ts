...
export const messages: Record<'zh' | 'en', Record<string, string>> = {
  zh: {
    ...
    // ---- settings ----
    'settings.title': '设置',
    'settings.pageDesc': '管理应用偏好，并确认当前应用信息。',
    ...
    'settings.cliStatus.sourceSandbox': '沙盒',
    ...
    'onboarding.systemManageDesc': '已检测到系统版本会直接使用；缺失项会按各自方式自动安装，Hermes 使用官方安装器。',
    ...
    'onboarding.pathCount': '共检测到 {count} 个路径',
    ...
    'config.resolvedEnvDesc': '启动 {cliId} 时实际注入的环境变量（密钥已脱敏）。使用系统 CLI 时不会重定向配置目录。',
    ...
    'config.pricingTitle': '价格',
    'config.pricingDesc': '按 agent 维护常用模型价格，单位为每 100 万 token。这里先作为本地记录，不会自动改写 CLI 原生配置。',
    'config.addPrice': '新增价格',
    'config.noPrices': '还没有价格记录。',
    'config.untitledPrice': '未命名价格',
    'config.priceName': '名称',
    'config.priceProvider': '供应商',
    'config.priceModel': '模型',
    'config.priceCurrency': '币种',
    'config.priceInput': '输入 / 1M',
    'config.priceOutput': '输出 / 1M',
    'config.priceCacheRead': '缓存读 / 1M',
    'config.priceCacheWrite': '缓存写 / 1M',
    'config.mcpTitle': 'MCP 服务器',
    'config.mcpDesc': '展示当前 agent 原生配置里的 MCP 条目。',
    'config.addMcp': '新增 MCP',
    ...
    'config.untitledMcp': '未命名 MCP',
    'config.mcpName': '名称',
    'config.mcpTransport': '传输',
    'config.mcpCommand': '命令',
    'config.mcpArgs': '参数',
    'config.mcpUrl': 'URL',
    'config.mcpEnv': '环境变量',
    ...
    'config.addSkill': '新增 Skill',
    'config.noSkills': '还没有 Skill。',
    'config.untitledSkill': '未命名 Skill',
    'config.skillName': '名称',
    'config.skillSource': '来源',
    'config.skillDescription': '描述',
    'config.skillsShDesc': '从 skills.sh 搜索并安装到当前 agent，安装后的记录会标记来源为 skills.sh。',
    'config.skillsShPlaceholder': '搜索 skill，如 react、linear、release notes',
    'config.skillsShSearch': '搜索',
    'config.skillsShSearching': '搜索中…',
    'config.skillsShInstall': '安装',
    'config.skillsShInstalling': '安装中…',
    'config.skillsShInstalled': '已安装',
    'config.skillsShInstalls': '{count} 次安装',
    'config.skillsShInstallDone': '已从 skills.sh 安装 {name}',
    'config.enabled': '启用',
    'config.disabled': '停用',
    'config.notes': '备注',
  ...
  en: {
    ...
    'settings.pageDesc': 'Manage app preferences and check app details.',
    ...
    'settings.cliStatus.sourceSandbox': 'Sandbox',
    ...
    'onboarding.systemManageDesc':
      'Detected system CLIs are used directly. Missing items install through their own path; Hermes uses its official installer.',
    ...
    'onboarding.pathCount': '{count} paths detected',
    ...
    'onboarding.authLoggingIn': 'Logging in…',
    ...
    'config.resolvedEnvDesc':
      'The environment variables actually injected when launching {cliId} (secrets masked). System CLIs do not redirect config directories.',
    ...
    'config.priceName': 'Name',
    'config.priceProvider': 'Provider',
    'config.priceModel': 'Model',
    'config.priceCurrency': 'Currency',
    'config.priceInput': 'Input / 1M',
    'config.priceOutput': 'Output / 1M',
    'config.priceCacheRead': 'Cache read / 1M',
    'config.priceCacheWrite': 'Cache write / 1M',
    'config.mcpTitle': 'MCP servers',
    'config.mcpDesc': 'Show MCP entries from this agent’s native config.',
    'config.addMcp': 'Add MCP',
    ...
    'config.untitledMcp': 'Untitled MCP',
    'config.mcpName': 'Name',
    'config.mcpTransport': 'Transport',
    'config.mcpCommand': 'Command',
    'config.mcpArgs': 'Arguments',
    'config.mcpUrl': 'URL',
    'config.mcpEnv': 'Environment',
    ...
    'config.addSkill': 'Add skill',
    'config.noSkills': 'No skills yet.',
    'config.untitledSkill': 'Untitled skill',
    'config.skillName': 'Name',
    'config.skillSource': 'Source',
    'config.skillDescription': 'Description',
    'config.skillsShDesc': 'Search skills.sh and install into the current agent. Installed records are labeled as skills.sh.',
    'config.skillsShPlaceholder': 'Search skills, e.g. react, linear, release notes',
    'config.skillsShSearch': 'Search',
    'config.skillsShSearching': 'Searching…',
    'config.skillsShInstall': 'Install',
    'config.skillsShInstalling': 'Installing…',
    'config.skillsShInstalled': 'Installed',
    'config.skillsShInstalls': '{count} installs',
    'config.skillsShInstallDone': 'Installed {name} from skills.sh',
