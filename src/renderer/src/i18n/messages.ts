...
export const messages: Record<'zh' | 'en', Record<string, string>> = {
  zh: {
    ...
    'config.mcpDesc': '读取并管理当前 agent 原生配置里的 MCP 条目。',
    ...
    'config.skillsDesc': '读取当前 agent 已安装的 Skill，可搜索、编辑名称/描述或删除。',
  ...
  en: {
    ...
    'config.mcpDesc': 'Read and manage MCP entries from this agent’s native config.',
    ...
    'config.skillsDesc': 'Read installed skills for this agent; search, edit name/description, or delete.',
