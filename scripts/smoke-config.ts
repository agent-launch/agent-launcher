...
const c1 = addProfile('claude-code', { name: 'AiHubMix · Opus', providerId: 'aihubmix', baseUrl: 'https://aihubmix.com', apiKey: 'sk-test-1234567890', model: 'opus' })
const c2 = addProfile('claude-code', { name: 'DMXAPI', providerId: 'dmxapi', baseUrl: 'https://www.dmxapi.cn', apiKey: 'sk-dmx-abcdefgh' })
